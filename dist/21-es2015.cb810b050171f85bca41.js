  ...
  [21],
  {
    '55KT': function(n, c, e) {
      ...
      let m = (() => {
          class n {
            constructor(n) {
              (this.translate = n), (this.tag = p.t);
            }
            ngOnInit() {}
          }
          return (
            (n.ɵfac = function(c) {
              return new (c || n)(l.Lb(g.c));
            }),
            (n.ɵcmp = l.Fb({
              type: n,
              ...
              template: function(n, c) {
                1 & n &&
                  ...
                  2 & n &&
                    ...
                    l.xb(7),
                    l.kc('ngClass', 'shape-fill-contrast'),
                    l.xb(11),
                    l.Hc(
                      '\n          ',
                      l.hc(
                    ...
                    l.Hc(
                      '\n          ',
                      l.hc(27, 13, 'DEMOS.SAAS.HEADING.OUT_IAS_ARE_POISED'),
                      '.\n        '
                    ),
                    l.xb(7),
                    l.kc('icon', c.tag),
                    ...
                    l.Hc(
                      '\n            ',
                      l.hc(35, 15, 'DEMOS.SAAS.HEADING.PLANS_AND_PRICING'),
                      '\n          '
                    ),
                    l.xb(4),
                    l.Hc(
                      '\n            ',
                      l.hc(39, 17, 'DEMOS.SAAS.HEADING.START_NOW'),
                      '\n          '
                    ));
              },
              directives: [E.i, S.a],
            ...
            template: function(n, c) {
              1 & n &&
                ...
                2 & n &&
                  ...
                  l.xb(3),
                  l.kc('routerLink', l.nc(13, h)),
                  l.xb(1),
                  l.Hc(
                    '\n          ',
                    l.hc(22, 11, 'DEMOS.SAAS.LIGHTWEIGHT_TEMPLATE.LEARN_MORE'),
                    '\n        '
                  ));
            },
            directives: [d.f],
      ...
      let Q = (() => {
        class n {
          constructor(n) {
            (this.translate = n), (this.currentSlide = 0);
          }
          ngOnInit() {}
          updateSlider(n) {
            this.currentSlide = n;
            ...
            template: function(n, c) {
              1 & n &&
                ...
                2 & n &&
                  ...
                  l.xb(6),
                  l.kc('ngForOf', l.nc(52, L)),
                  l.xb(3),
                  l.kc('index', c.currentSlide),
                  l.xb(18),
                  l.kc('bg', 'contrast')('text', 'primary'),
                  l.xb(1),
                  l.Hc(
                    '\n                ',
                    l.hc(
                  ...
                  l.Hc(
                    '\n                ',
                    l.hc(44, 30, 'SLIDERS.SLIDER_ALL_IN_ONE.AFFORDABILLITY'),
                    '\n              '
                  ),
                  l.xb(23),
                  l.kc('bg', 'contrast')('text', 'primary'),
                  ...
                  l.Hc(
                    '\n                ',
                    l.hc(81, 36, 'SLIDERS.SLIDER_ALL_IN_ONE.ALWAYS_ON_TIME'),
                    '\n              '
                  ),
                  l.xb(20),
                  l.kc('bg', 'contrast')('text', 'primary'),
                  ...
                  l.Hc(
                    '\n                ',
                    l.hc(114, 44, 'SLIDERS.SLIDER_ALL_IN_ONE.OUTSTANDING'),
                    '\n              '
                  ),
                  l.xb(23),
                  l.kc('bg', 'contrast')('text', 'primary'),
                  ...
                  l.Hc(
                    '\n                ',
                    l.hc(141, 46, 'SLIDERS.SLIDER_ALL_IN_ONE.ANALYTICS'),
                    '\n              '
                  ),
                  l.xb(4),
                  l.Hc(
                    '\n                ',
                    l.hc(145, 48, 'SLIDERS.SLIDER_ALL_IN_ONE.SIT_BACK_AS_YOUR'),
                    '\n              '
                  ),
                  l.xb(4),
                  l.Hc(
            ...
            component: (() => {
              ...
              return (
                ...
                (n.ɵcmp = l.Fb({
                  ...
                  template: function(n, c) {
                    1 & n &&
                      (l.Mb(0, 'dc-saas-heading'),
                      l.Fc(1, '\n\n'),
                      l.Mb(2, 'dc-saas-perspective-mockups'),
                      l.Fc(3, '\n'),
                      l.Mb(4, 'dc-saas-lightweight-template'),
                      l.Fc(5, '\n'),
                      l.Mb(6, 'dc-slider-start-right-way'),
                      l.Fc(7, '\n'),
                      l.Mb(8, 'dc-slider-all-in-one'),
                      l.Fc(9, '\n'),
                      l.Mb(10, 'dc-testimonial-simple-text-left'),
                      l.Fc(11, '\n'),
                      l.Qb(12, 'dc-big-screen', 0),
                      l.Fc(13, '\n  '),
                      l.Qb(14, 'div', 1),
                      l.Fc(15, '\n    '),
                      l.Qb(16, 'p', 2),
                      ...
                      l.Qb(29, 'div', 4),
                      l.Fc(30, '\n    '),
                      l.Dc(31, y, 10, 4, 'div', 5),
                      l.Fc(32, '\n  '),
                      l.Pb(),
                      l.Fc(33, '\n'),
                      l.Pb(),
                      l.Fc(34, '\n\n'),
                      l.Qb(35, 'dc-big-screen', 6),
                      l.Fc(36, '\n  '),
                      l.Qb(37, 'div', 7),
                      l.Fc(38, '\n    '),
                      l.Qb(39, 'span', 8),
                      l.Fc(40, '\n      '),
                      l.Mb(41, 'dc-feather', 9),
                      l.Fc(42, '\n      '),
                      l.Qb(43, 'span', 10),
                      l.Fc(44),
                      l.gc(45, 'translate'),
                      ...
                      l.Pb(),
                      l.Fc(86, '\n\n'),
                      l.Mb(87, 'dc-trust-us', 22),
                      l.Fc(88, '\n'),
                      l.Mb(89, 'dc-faqs1', 23),
                      l.Fc(90, '\n'),
                      l.Mb(91, 'dc-start-now-box'),
                      l.Fc(92, '\n'),
                      l.Mb(93, 'dc-cta1'),
                      l.Fc(94, '\n\n'),
                      l.Mb(95, 'dc-footer2'),
                      ...
                      2 & n &&
                        (l.xb(12),
                        l.kc('img', 'assets/img/screens/dash/5.png'),
                        l.xb(5),
                        l.Hc(
                          '\n      ',
                          l.hc(18, 17, 'DEMOS.SAAS.BUILD_TO_LAST'),
                          '\n    '
                        ),
                        l.xb(4),
                        l.Gc(
                        ...
                        l.xb(3),
                        l.Gc(l.hc(45, 23, 'DEMOS.SAAS.DASHBORD_INCLUDED')),
                        l.xb(5),
                        l.Hc(
                          '\n      ',
                          l.hc(50, 25, 'DEMOS.SAAS.SIMPLE_IMPLEMENTATION'),
                          '\n    '
                        ),
                        l.xb(4),
                        l.Hc(
                          '\n      ',
                          l.hc(54, 27, 'DEMOS.SAAS.SINCE_THE_NEED_FOR_HUMAN'),
                          '\n    '
                        ),
                        l.xb(5),
                        l.Hc(
                          '\n    ',
                          l.hc(59, 29, 'DEMOS.SAAS.THE_POSSIBILITIES'),
                          '\n  '
                        ),
                        l.xb(4),
                        l.Gc(l.hc(63, 31, 'DEMOS.SAAS.Learn_More')),
                        l.xb(25),
                        l.kc('title', 'They trust us')(
                          'containerClass',
                          'pb-0'
                        ),
                        l.xb(2),
                        l.kc('edge', 'bottom-right')('background', 'light'));
                  },
                  directives: [
                    m,
                    u,
        ...
        W = (() => {
          ...
          return (
            ...
            (n.ɵinj = l.Ib({
              ...
              imports: [[t.a, a.a, s.a, r.a, i.a, b.a, o.a, Y, g.a.forChild()]]
            })),
            n
          );
        })();

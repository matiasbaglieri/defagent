        ...
        return (
          ...
          (n.ɵcmp = c.Fb({
            ...
            template: function(n, t) {
              1 & n && (c.Mb(0, 'i-feather', 0), c.Fc(1, '\n')),
                2 & n &&
                  (c.zb('wh' + t.size),
                  c.kc('name', t.name)('ngClass', t.iconClass));
            },
            directives: [r.a, o.i],
            styles: [
          ...
          (n.ɵcmp = o.Fb({
            ...
            template: function(n, t) {
              1 & n &&
                ...
                2 & n &&
                  (o.xb(16),
                  o.kc('routerLink', o.nc(2, i)),
                  o.xb(20),
                  o.kc('routerLink', o.nc(3, a)));
            },
            directives: [s.f],
            styles: ['']
          })),

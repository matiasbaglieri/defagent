(window.webpackJsonp = window.webpackJsonp || []).push([
  [26],
  {
    gJiE: function(n, t, e) {
      'use strict';
      e.r(t),
        e.d(t, 'CorporateModule', function() {
          return _;
        });
      var c = e('M0ag'),
        a = e('M0Rk'),
            ...
            template: function(n, t) {
              1 & n &&
                ...
                2 & n &&
                  ...
                  g.Hc(
                    '\n            ',
                    g.hc(28, 16, 'DEMOS.HEALTH.CORPORATE.HEADING.START_NOW'),
                    '\n          '
                  ),
                  g.xb(5),
                  g.zb('mr-3'),
      ...
      function f(n, t) {
        if (
          ...
          g.xb(2),
            g.Cc(
              'background-image',
              'url(assets/images/corporate/lcards/' + n.img + '.svg)'
            ),
            g.xb(3),
            g.Gc(n.title),
            g.xb(3),
      ...
      let S = (() => {
        class n {
          constructor(n) {
            (this.translate = n), (this.quoteLeft = p.q);
          }
          ngOnInit() {}
        }
        return (
      ...
      const M = [
        {
          ...
          component: (() => {
            ...
            return (
              ...
              (n.ɵcmp = g.Fb({
                ...
                template: function(n, t) {
                  1 & n &&
                    (g.Mb(0, 'dc-corporate-heading'),
                    g.Fc(1, '\n'),
                    g.Mb(2, 'dc-slider-icons'),
                    g.Fc(3, '\n\n'),
                    g.Mb(4, 'dc-features-icons-col'),
                    g.Fc(5, '\n'),
                    g.Mb(6, 'dc-slider-start-right-way'),
                    g.Fc(7, '\n'),
                    g.Mb(8, 'dc-testimonial-simple-text-left'),
                    g.Fc(9, '\n'),
                    g.Mb(10, 'dc-corporate-do-business'),
                    g.Fc(11, '\n'),
                    g.Qb(12, 'dc-big-screen', 0),
                    g.Fc(13, '\n  '),
                    g.Qb(14, 'h2'),
                    g.Fc(15),
                    g.gc(16, 'translate'),
                    ...
                    g.Pb(),
                    g.Fc(44, '\n'),
                    g.Mb(45, 'dc-testimonial-simple-text-right'),
                    g.Fc(46, '\n'),
                    g.Mb(47, 'dc-faqs1'),
                    g.Fc(48, '\n'),
                    g.Mb(49, 'dc-footer2'),
                    ...
                    2 & n &&
                      (g.xb(12),
                      g.kc('img', 'assets/images/corporate/screens/dash/2.png')(
                        'screenPos',
                        'left'
                      ),
                      g.xb(3),
                      g.Hc(
                        '\n    ',
                        g.hc(16, 9, 'DEMOS.HEALTH.CORPORATE.DID_YOU_KNOW'),
                        '\n  '
                      ),
                      g.xb(4),
                      g.Hc(
                      ...
                      g.xb(9),
                      g.kc('img', 'assets/images/corporate/screens/dash/1.png')(
                        'screenPos',
                        'right'
                      ),
                      g.xb(3),
                      ...
                      g.xb(6),
                      g.Gc(g.hc(42, 17, 'DEMOS.HEALTH.CORPORATE.LEARN_MORE')));
                },
                directives: [T, h.a, u.a, m.a, O.a, A, I.a, S, P.a, v.a],
                pipes: [E.b],
                styles: ['']
              })),
              n
          ...
          data: { title: Object(d.c)('EveryThink Health') }
        }
      ];
      let R = (() => {
          class n {}
        ...
        _ = (() => {
          ...
          return (
            ...
            (n.ɵinj = g.Ib({
              ...
              imports: [[c.a, a.a, i.a, r.a, s.a, o.a, b.a, R, E.a.forChild()]]
            })),
            n
          );
        })();

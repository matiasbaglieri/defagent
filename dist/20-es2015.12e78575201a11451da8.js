(window.webpackJsonp = window.webpackJsonp || []).push([
  [20],
  {
    ...
    ZsP5: function(n, c, t) {
      'use strict';
      t.r(c),
        t.d(c, 'DevelopersModule', function() {
          return A;
        });
      var e = t('M0ag'),
        i = t('V6j0'),
          ...
          (n.ɵcmp = F.Fb({
            ...
            template: function(n, c) {
              1 & n &&
                ...
                F.Fc(34, '\n')),
                2 & n &&
                  (F.Cc('background-image', 'url(assets/img/bg/grid.jpg)'),
                  F.xb(9),
                  F.Hc(
                    '\n          ',
                    F.hc(10, 10, 'DEMOS.DEVELOPERS.HEADING.WELCOME_DREAMERS'),
                    '\n        '
                  ),
                  F.xb(4),
                  F.Hc(
                    '\n          ',
                    F.hc(14, 12, 'DEMOS.DEVELOPERS.HEADING.CREATE_EMOTIONS'),
                    '\n        '
                  ),
                  F.xb(5),
                  F.kc('strings', F.nc(16, p))('typeSpeed', 150)(
                    'backDelay',
                    500
                  )('backSpeed', 50)('loop', !0),
                  F.xb(9),
                  F.Hc(
                    '\n            ',
                    F.hc(28, 14, 'DEMOS.DEVELOPERS.HEADING.SHOW_VIDEO'),
                    '\n          '
                  ));
            },
            directives: [b.b],
      ...
      function v(n, c) {
        if (
          ...
          F.Db('b-md-r', 2 != t),
            F.xb(2),
            F.kc('routerLink', F.nc(7, x)),
            F.xb(3),
            F.Gc(n.title),
            F.xb(4),
            F.Gc(n.description),
            F.xb(2),
            F.kc('routerLink', F.nc(8, x)),
            F.xb(2),
            F.kc('icon', e.longArrowAltRight);
        }
      }
      let P = (() => {
        class n {
            ...
            template: function(n, c) {
              1 & n &&
                ...
                2 & n &&
                  ...
                  F.Hc(
                    '\n        ',
                    F.hc(9, 5, 'DEMOS.DEVELOPERS.INTEGRATioNS.LEARN_MORE'),
                    '\n        '
                  ),
                  F.xb(17),
                  F.kc('ngForOf', c.blocks));
            },
            directives: [E.a, f.j, l.f, h.a],
            pipes: [g.b],
            styles: ['']
          })),
          n
        ...
        if (1 & n) {
          ...
          F.Qb(0, 'a', 22),
            F.bc('click', function() {
              F.vc(n);
              const t = c.index;
              return F.fc().updateSlider(t);
            }),
            F.Fc(1, '\n                  '),
            F.Mb(2, 'dc-feather', 23),
            F.Fc(3, '\n                '),
            F.Pb();
        }
        if (2 & n) {
          const n = c.$implicit,
            t = c.index,
            e = F.fc();
          F.Db('active', t === e.currentSlide)('pl-md-0', 0 === t),
            F.yb('data-step', t + 1),
            F.xb(2),
            F.kc('name', n.icon)('size', 24);
        }
      }
      function I(n, c) {
        if (
          ...
          const n = c.$implicit;
          F.xb(4),
            F.kc('src', 'assets/img/screens/dash/' + n.img + '.png', F.yc),
            F.xb(4),
            F.Hc(
              '\n              ',
              F.hc(9, 2, 'SLIDERS.SLIDER_BRING_TO_LIFE.CLEAN_INBOX_UI'),
              '\n            '
            );
        }
      }
            ...
            template: function(n, c) {
              1 & n &&
                ...
                2 & n &&
                  (F.xb(20),
                  F.zb('mr-3'),
                  F.kc('name', 'bar-chart')('iconClass', 'stroke-primary'),
                  F.xb(5),
                  F.Hc(
                    '\n                ',
                    F.hc(
                  ...
                  F.xb(10),
                  F.zb('mr-3'),
                  F.kc('name', 'smartphone')('iconClass', 'stroke-primary'),
                  F.xb(7),
                  F.Hc(
                    '\n                ',
                    F.hc(
                  ...
                  F.xb(5),
                  F.kc('index', c.currentSlide),
                  F.xb(2),
                  F.kc('ngForOf', c.elements));
            },
            directives: [E.a, f.j, O.a],
            pipes: [g.b],
            styles: ['']
          })),
          n
      ...
      function R(n, c) {
        if (
          ...
          const n = c.$implicit,
            t = F.fc();
          F.Ab('col-6 col-sm-5 col-md-6 col-lg-5 ', n.class, ''),
            F.xb(2),
            F.Ab(
              '',
              n.bg,
            ...
            F.yb('data-aos', n.animation),
            F.xb(2),
            F.kc('src', 'assets/img/logos/' + n.img + '.svg', F.yc),
            F.xb(3),
            F.Gc(n.title),
            F.xb(3),
            F.Hc(
              '\n                ',
              F.hc(11, 12, 'DEMOS.DEVELOPERS.TOOL.LOREM_IPSUM_DOLOR'),
              '.\n              '
            ),
            F.xb(5),
            F.kc('icon', t.longAarrowAltRight),
            F.xb(3),
            F.Hc('', F.hc(19, 14, 'DEMOS.DEVELOPERS.TOOL.INTEGRATE'), '.');
        }
      }
      let Q = (() => {
        class n {
          ...
          (n.ɵcmp = F.Fb({
            ...
            template: function(n, c) {
              1 & n &&
                ...
                2 & n &&
                  (F.xb(13),
                  F.kc('name', 'box')('iconClass', 'stroke-primary'),
                  F.xb(3),
                  F.Hc(
                    '\n          ',
                    F.hc(17, 6, 'DEMOS.DEVELOPERS.TOOL.INTEGRATION_TOOLS'),
                    '\n        '
                  ),
                  F.xb(4),
                  F.Hc(
                    '\n          ',
                    F.hc(21, 8, 'DEMOS.DEVELOPERS.TOOL.EASY_INTEGRATIONS'),
                    '\n        '
                  ),
                  F.xb(4),
                  F.Hc(
                    '\n          ',
                    F.hc(25, 10, 'DEMOS.DEVELOPERS.TOOL.LOREM_IPSUM'),
                    '\n        '
                  ),
                  F.xb(8),
                  F.kc('ngForOf', c.cards));
            },
            directives: [E.a, f.j, h.a],
            pipes: [g.b],
            styles: ['']
          })),
          n
          ...
          component: (() => {
            ...
            return (
              ...
              (n.ɵcmp = F.Fb({
                ...
                template: function(n, c) {
                  1 & n &&
                    (F.Mb(0, 'dc-developers-heading'),
                    F.Fc(1, '\n'),
                    F.Mb(2, 'dc-developers-integration'),
                    F.Fc(3, '\n'),
                    F.Fc(4, '\n'),
                    F.Mb(5, 'dc-slider-bring-to-life'),
                    F.Fc(6, '\n\n'),
                    F.Fc(7, '\n'),
                    F.Fc(8, '\n\n'),
                    F.Mb(9, 'dc-developers-integration-tools'),
                    F.Fc(10, '\n\n'),
                    F.Mb(11, 'dc-trust-us', 0),
                    F.Fc(12, '\n'),
                    F.Mb(13, 'dc-developer-designer'),
                    F.Fc(14, '\n\n'),
                    F.Mb(15, 'dc-cta1', 1),
                    F.Fc(16, '\n\n'),
                    F.Mb(17, 'dc-footer2'),
                ...
                directives: [m, P, L, Q, y.a, D.a, _.a, M.a],
                styles: ['']
              })),
              n
            );
        ...
        A = (() => {
          ...
          return (
            ...
            (n.ɵinj = F.Ib({
              ...
              imports: [[e.a, i.a, a.a, r.a, s.a, o.a, b.a, T, g.a.forChild()]]
            })),
            n
          );
        })();

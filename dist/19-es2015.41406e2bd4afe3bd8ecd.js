(window.webpackJsonp = window.webpackJsonp || []).push([
  [19],
  {
    '/jaR': function(n, e, t) {
      'use strict';
      t.r(e),
        t.d(e, 'OnlinePaymentModule', function() {
          return H;
        });
      var c = t('M0ag'),
        s = t('ORAR'),
      ...
      function v(n, e) {
        if (
          ...
          d.xb(21),
            d.zb('icon center-xy'),
            d.kc('name', n.icon)('iconClass', 'stroke-contrast'),
            d.xb(4),
            d.Gc(n.title),
            d.xb(3),
            d.Hc('\n          ', n.description, '\n        ');
        ...
        return (
          ...
          (n.ɵcmp = d.Fb({
            ...
            consts: [
              ...
              [1, 'col-md-4', 'py-4', 'rounded', 'shadow-hover', 'text-center'],
              [1, 'icon-shape', 'mb-4'],
              [
                'xmlns',
      ...
      function P(n, e) {
        if (
          ...
          const n = e.$implicit,
            t = e.index;
          d.xb(2),
            d.Db('order-md-2', (t + 1) % 2 == 0),
            d.xb(2),
            d.yb('data-aos', (t + 1) % 2 == 0 ? 'fade-left' : 'fade-right'),
            d.xb(2),
            d.Ab('img-responsive ', n.image.class, ''),
            d.mc(
              'src',
            ...
            (n.ɵcmp = d.Fb({
              ...
              template: function(n, e) {
                1 & n &&
                  ...
                  d.Qb(9, 'div', 4),
                  d.Fc(10, '\n    '),
                  d.Dc(11, P, 52, 12, 'div', 5),
                  d.Fc(12, '\n  '),
                  d.Pb(),
                  d.Fc(13, '\n'),
                  d.Pb(),
                  d.Fc(14, '\n')),
                  2 & n && (d.xb(11), d.kc('ngForOf', e.steps));
              },
              directives: [h.j, h.k, u.a],
              styles: ['']
            })),
            n
          );
          ...
          (n.ɵcmp = d.Fb({
            ...
            template: function(n, e) {
              1 & n &&
                ...
                d.Qb(6, 'div', 3),
                d.Fc(7, '\n        '),
                d.Mb(8, 'dc-form-register-simple-inline'),
                d.Fc(9, '\n      '),
                d.Pb(),
                d.Fc(10, '\n    '),
                d.Pb(),
      ...
      function Q(n, e) {
        ...
        if (2 & n) {
          const n = e.$implicit,
            t = e.index,
            c = d.fc();
          d.Db('active', t === c.currentSlide),
            d.kc('ngStyle', d.pc(5, S, n.position.left, n.position.top)),
            d.yb('data-step', t),
            d.xb(4),
            d.kc('src', 'assets/img/avatar/' + (t + 1) + '.jpg', d.yc);
        }
      }
      function R(n, e) {
        1 & n &&
          ...
          2 & n &&
            ...
            d.Hc(
              '\n                  ',
              d.hc(16, 5, 'TESTIMONIALS.TESTIMONIAL_WORLD_MAP.JANE_DOE'),
              ''
            ),
            d.xb(2),
            d.Hc(
          ...
          (n.ɵcmp = d.Fb({
            ...
            template: function(n, e) {
              1 & n &&
                ...
                d.Fc(45, '\n        '),
                d.Qb(46, 'swiper', 17),
                d.bc('indexChange', function(n) {
                  return e.onIndexChange(n);
                }),
                d.Fc(47, '\n          '),
                d.Dc(48, R, 21, 9, 'div', 18),
                d.Fc(49, '\n        '),
                d.Pb(),
                d.Fc(50, '\n      '),
                d.Pb(),
                ...
                2 & n &&
                  ...
                  d.xb(14),
                  d.kc('ngForOf', e.reviews),
                  d.xb(7),
                  d.kc('index', e.currentSlide),
                  d.xb(2),
                  d.kc('ngForOf', e.reviews));
            },
            directives: [h.j, A.a, h.l],
            pipes: [F.b],
            styles: ['']
          })),
          n
      ...
      function I(n, e) {
        if (
          ...
          d.xb(2),
            d.Cc(
              'background-image',
              'url(assets/images/online-payment/payments/' + n.img + '.svg)'
            ),
            d.xb(3),
            d.Gc(n.title),
            d.xb(3),
          ...
          (n.ɵcmp = d.Fb({
            ...
            template: function(n, e) {
              1 & n &&
                ...
                d.Pb(),
                d.Fc(10, '\n')),
                2 & n && (d.xb(6), d.kc('ngForOf', e.cards));
            },
            directives: [h.j],
            styles: ['']
          })),
          ...
          component: (() => {
            ...
            return (
              ...
              (n.ɵcmp = d.Fb({
                ...
                template: function(n, e) {
                  1 & n &&
                    (d.Mb(0, 'dc-online-payment-heading'),
                    d.Fc(1, '\n'),
                    d.Mb(2, 'dc-online-payment-features'),
                    d.Fc(3, '\n'),
                    d.Mb(4, 'dc-online-payment-steps'),
                    d.Fc(5, '\n'),
                    d.Mb(6, 'dc-online-payment-customers-management'),
                    d.Fc(7, '\n'),
                    d.Mb(8, 'dc-online-payment-register'),
                    d.Fc(9, '\n'),
                    d.Mb(10, 'dc-testimonial-world-map'),
                    d.Fc(11, '\n'),
                    d.Mb(12, 'dc-trust-us', 0),
                    d.Fc(13, '\n'),
                    d.Mb(14, 'dc-online-payment-send-receive'),
                    d.Fc(15, '\n'),
                    d.Mb(16, 'dc-cta1', 1),
                    d.Fc(17, '\n'),
                    d.Mb(18, 'dc-footer2'),
                    ...
                    2 & n &&
                      (d.xb(12),
                      d.kc('title', 'They trust us'),
                      d.xb(4),
                      d.kc('edge', 'top-left')('background', 'contrast'));
                },
                directives: [g, y, x, M, w, T, N.a, k, _.a, C.a],
                styles: ['']
              })),
              n
            );
          })(),
          data: { title: Object(l.c)('Online Payment') }
        }
      ];
      let D = (() => {
          class n {}
        ...
        H = (() => {
          ...
          return (
            ...
            (n.ɵinj = d.Ib({
              ...
              imports: [[c.a, s.a, i.a, a.a, o.a, r.a, D, F.a.forChild()]]
            })),
            n
          );
        })();
